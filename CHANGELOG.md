...
- Read-only reviewer probes of missing optional paths are treated as negative evidence rather than fatal process errors, and one operationally failed specialist is retried once in fresh context without discarding successful peer reviews.
