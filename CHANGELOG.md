...
- Verification runners snapshot their environment instead of relying on mutable process-global state, preventing concurrent sparse-PATH toolchain probes from contaminating one another. Baseline-equivalent required failures are now rendered as failed rather than misleadingly labeled as passed.
