...
const modules = [
  ...
  "dist/tui/forgedock-extension.test.js",
  ...
  "dist/workflows/work-on/remediate.test.js",
  "dist/workflows/review-pr/review.test.js",
  "dist/workflows/review-pr/scope.test.js",
  ...
  "dist/core/packet/investigation-scope.test.js",
  "dist/core/packet/relation-checkpoint-certification.test.js",
  "dist/workflows/work-on/prepare.test.js",
  "dist/workflows/work-on/prepare.relation-graph.test.js",
  "dist/workflows/work-on/work-on.test.js",
...
const coverage = {
  ...
  "active-stop-session": ["forgedock-extension"],
  ...
  "runtime-budgets": ["agent-runtime", "agent-budget-retry", "scheduler", "controller"],
  "reviewer-semantic-conformance": ["review", "scope", "remediate", "verify"],
  "investigation-scope-handoff": ["investigation-scope", "relation-checkpoint-certification", "prepare", "work-on"],
