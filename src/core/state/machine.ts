...
const transitions: Readonly<Record<RunStateName, Partial<Record<TransitionEvent, RunStateName>>>> = {
  ...
  invalid: {},
  decomposed: {},
  blocked: { RESUME_VERIFICATION: "verifying", RESUME_REVIEW: "reviewing" },
...
export function transition(
  ...
  if (event === "RESUME_VERIFICATION" || event === "RESUME_REVIEW" || event === "RESUME_REMEDIATION" || event === "RESUME_COMPLETION" || event === "RESUME_BUILD" || event === "RESUME_PUBLICATION" || event === "RECOVER_REVISION_PUBLICATION") {
